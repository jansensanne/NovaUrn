 ...
 * This file demonstrates how to integrate Novaurn with a web frontend
 */

// For React/Vue/Angular applications
export class NovaurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NovaurnClient(provider, contractAddress);
